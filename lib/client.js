...
`;
			...
			return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
				...
				loading ? (0, import_jsx_runtime.jsx)("div", {
					...
					children: [
						...
						skill.source === "user" && (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							className: "dshm-btn danger",
							disabled: busy,
		...
		function KeysTab({ busy, setBusy, msg, setMsg }) {
			...
			const [loading, setLoading] = (0, react.useState)(true);
			const [setRef, setSetRef] = (0, react.useState)("");
			const [setValue, setSetValue] = (0, react.useState)("");
			const refresh = async () => {
			...
			const setKey = async () => {
				...
				setMsg(data.ok ? {
					ok: true,
					text: `已保存 ${setRef.trim()}（值已加密存储，不再回显）。`
				} : {
					ok: false,
					text: data.error ?? "failed"
				});
			...
			return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsxs)("div", {
				...
				children: [(0, import_jsx_runtime.jsx)("div", {
					className: "dshm-sec-title",
					children: "设置 / 更新 Key（值不会回显，只会显示已配置状态）"
				}), (0, import_jsx_runtime.jsx)("div", {
					className: "dshm-form",
					children: (0, import_jsx_runtime.jsxs)("div", {
						className: "dshm-form-row",
						children: [
							(0, import_jsx_runtime.jsx)("input", {
								className: "dshm-input",
								placeholder: "环境变量名（如 DEEPSEEK_V4_FLASH_API_KEY）",
								value: setRef,
							...
							(0, import_jsx_runtime.jsx)("button", {
								type: "button",
								className: "dshm-btn primary",
								disabled: busy || setRef.trim() === "" || setValue === "",
								onClick: () => void setKey(),
								children: "保存"
							})
						]
				...
				children: [(0, import_jsx_runtime.jsx)("div", {
					className: "dshm-sec-title",
					children: "已识别的凭据引用（来自模型供应商配置）"
				}), !available ? (0, import_jsx_runtime.jsx)("div", {
					className: "dshm-hint",
					children: "credentials 服务不可用（当前 profile 未提供）。"
				}) : loading ? (0, import_jsx_runtime.jsx)("div", {
					style: { color: "#6b7384" },
					children: "加载中…"
				}) : keys.length === 0 ? (0, import_jsx_runtime.jsx)("div", {
					className: "dshm-hint",
					children: "未发现模型供应商的 apiKeyEnv 引用。"
				}) : keys.map((row) => (0, import_jsx_runtime.jsxs)("div", {
					className: "dshm-row",
					children: [
						(0, import_jsx_runtime.jsx)("span", {
							className: `dshm-badge ${row.configured ? "ok" : "off"}`,
							children: row.configured ? "已配置" : "未配置"
						}),
						(0, import_jsx_runtime.jsx)("span", {
							className: "dshm-name dshm-mono",
							children: row.ref
						}),
						row.source !== void 0 && (0, import_jsx_runtime.jsxs)("span", {
							className: "dshm-id",
							children: ["来源: ", row.source]
						}),
						row.writable && (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							className: "dshm-btn danger",
							disabled: busy,
			...
			return (0, import_jsx_runtime.jsx)("div", {
				...
				children: (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						(0, import_jsx_runtime.jsxs)("div", {
							className: "dshm-head",
							children: [(0, import_jsx_runtime.jsx)("h2", { children: "DSH 管理控制台" }), (0, import_jsx_runtime.jsx)("button", {
								type: "button",
						...
						(0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								tab === "keys" && (0, import_jsx_runtime.jsx)(KeysTab, {
									busy,
									setBusy,
									msg,
									setMsg
